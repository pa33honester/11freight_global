...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/containers/create' },
];
...
const submit = () => {
    ...
    form.post('/containers', { preserveScroll: true });
};
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div>
                ...
                <p class="text-muted-foreground">Add a new container</p>
            </div>
                ...
                <form @submit.prevent="submit">
                    <CardContent class="space-y-4 pb-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="status" v-model="form.status" class="w-full rounded border p-2">
                    ...
                    <CardFooter class="flex justify-between">
                        ...
                        <Button type="submit" :disabled="form.processing">{{ form.processing ? 'Creating...' : 'Create Container' }}</Button>
                    </CardFooter>
                </form>
            </Card>
        </div>
