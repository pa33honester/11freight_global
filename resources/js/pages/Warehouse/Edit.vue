...
const submit = async () => {
  ...
  await form.put(`/warehouse/${item.id}`, { preserveScroll: true, forceFormData: true });
...
<template>
  ...
  <AppLayout :breadcrumbs="[{ title: 'Warehouse Inventory', href: '/warehouse' }, { title: 'Edit', href: `/warehouse/${item.id}/edit` }]">
    <div class="p-4">
